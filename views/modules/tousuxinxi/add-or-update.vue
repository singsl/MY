          ...
          <el-form-item class="input" label="标题" prop="biaoti">
              <el-input v-model="ruleForm.biaoti" 
                placeholder="标题" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投诉用户" prop="tousuyonghu">
          <el-input v-model="ruleForm.tousuyonghu" 
              placeholder="投诉用户" clearable  :readonly="ro.tousuyonghu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="投诉用户" prop="tousuyonghu">
              <el-input v-model="ruleForm.tousuyonghu" 
                placeholder="投诉用户" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                                                                                                                                                                        ...
                                                                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="头数内容" prop="toushuneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.toushuneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.toushuneirong" label="头数内容" prop="toushuneirong">
                    <span v-html="ruleForm.toushuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
            continue;
	            	            ...
	            	            if(o=='tousuyonghu'){
            this.ruleForm.tousuyonghu = obj[o];
	    this.ro.tousuyonghu = true;
            continue;
          }
	            	            if(o=='toushuneirong'){
            this.ruleForm.toushuneirong = obj[o];
	    this.ro.toushuneirong = true;
            continue;
          }
	            	            if(o=='tousuriqi'){
