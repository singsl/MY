...
public class TousuxinxiEntity<T> implements Serializable {
	...
	private String tousuyonghu;
	
	/**
	 * 头数内容
	 */
					
	private String toushuneirong;
	 ...
	 * 设置：投诉用户
	 */
	public void setTousuyonghu(String tousuyonghu) {
		this.tousuyonghu = tousuyonghu;
	}
	/**
	 * 获取：投诉用户
	 */
	public String getTousuyonghu() {
		return tousuyonghu;
	}
	/**
	 * 设置：头数内容
